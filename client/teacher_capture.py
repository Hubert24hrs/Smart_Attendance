...
def start_session():
    ...
    resp = requests.post(f"{API_URL}/sessions/start?course_name={course}", headers=headers)
    if resp.status_code == 200:
...
def main():
    ...
    if mode == "1":
        ...
        print("For Enrollment, please use the Web Admin Dashboard or API directly (Multipart upload required).")
